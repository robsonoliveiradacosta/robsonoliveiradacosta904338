---
name: domain-module
description: "Implement a domain module end to end across migration, entity, repository, service, resource, DTOs, and tests."
---
...
6. Keep REST resources thin and consistent with `/v1` routes.
